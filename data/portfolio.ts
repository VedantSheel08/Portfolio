...
export const projects = [
  {
    id: 1,
    name: "Immediate Pulmonary Fibrosis Prognosis",
  ...
  },
  {
    id: 3,
    name: "ASL Translator",
    tech: ["CNN", "TTS", "Computer Vision", "Flask"],
    description: [
      "Real-time American Sign Language translation",
  ...
  {
    id: 6,
    name: "Smart Solar Tracker",
    tech: ["Arduino", "IoT", "Renewable Energy"],
    description: [
