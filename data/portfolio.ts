export const personalInfo = {
  ...
  subtitle: "Building Tech With Purpose. One Code at a time.",
  intro:
    "Hi, I'm Vedant Sheel — a machine learning enthusiast and real-world problem solver with a 98% GPA, leading 4 school clubs, and building award-winning AI applications from wildfire detection to medical diagnosis.",
...
export const awards = [
  {
    ...
    description: "National recognition for AI innovation in bridging language gaps for Deaf and hard-of-hearing community using ASL",
  },
  {
    year: "2024",
...
export const experience = [
  ...
  },
  {
    ...
    role: "President – 4 Clubs",
    description: [
      "President of DECA – Qualified for ICDC, led training and organized competitions",
      "President of Math Club – Ran Euclid and CSMC prep, hosted math contests",
      "President of Coding Club – Taught algorithms, led CCC prep, created internal school apps",
      "President of Robotics Club – Built autonomous bots, led workshops and STEM outreach"
    ],
    period: "2023 – Present",
    expandable: true
  }
